...
export const metadata: Metadata = {
  title: '404',
  description: 'Quelque chose s’est mal passé. La page que vous recherchez est introuvable.',
}
...
export default function NotFound() {
  return (
    <div className="flex min-h-[calc(100vh-64px)] flex-col items-center justify-center gap-6">
      ...
      <Button asChild>
        <LocalizedClientLink href="/">Retourner à l’accueil</LocalizedClientLink>
      </Button>
    </div>
  )
}
