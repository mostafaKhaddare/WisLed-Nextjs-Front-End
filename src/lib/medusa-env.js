const DEFAULT_RENDER_MEDUSA_URL = 'https://wisled-medusa-back-end-1.onrender.com'
...
function normalizeMedusaUrl(url) {
  if (!url) return url
  return url.trim().replace(/\/+$/, '')
}

function getMedusaBackendUrl(env = process.env) {
